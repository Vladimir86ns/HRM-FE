...
export const RESPONSE_ACCOUNT_SUCCESS = 'RESPONSE_ACCOUNT_SUCCESS';
export const RESPONSE_ACCOUNT_NOT_FOUND = 'RESPONSE_ACCOUNT_NOT_FOUND';
export const RESPONSE_ACCOUNT_NOT_ACCEPTABLE = 'RESPONSE_ACCOUNT_NOT_ACCEPTABLE';
export const RESPONSE_ACCOUNT_FAILURE = 'RESPONSE_ACCOUNT_FAILURE';
...
export const RESPONSE_COMPANY_SUCCESS = 'RESPONSE_COMPANY_SUCCESS';
export const RESPONSE_COMPANIES_SUCCESS = 'RESPONSE_COMPANIES_SUCCESS';
export const RESPONSE_COMPANY_SUCCESS_ALL_EMPLOYEES = 'RESPONSE_COMPANY_SUCCESS_ALL_EMPLOYEES';
export const RESPONSE_COMPANY_NOT_FOUND = 'RESPONSE_COMPANY_NOT_FOUND';
export const RESPONSE_COMPANY_NOT_ACCEPTABLE = 'RESPONSE_COMPANY_NOT_ACCEPTABLE';
export const RESPONSE_COMPANY_FAILURE = 'RESPONSE_COMPANY_FAILURE';
...
export const RESPONSE_USER_NOT_FOUND = 'RESPONSE_USER_NOT_FOUND';
export const RESPONSE_USER_NOT_ACCEPTABLE = 'RESPONSE_USER_NOT_ACCEPTABLE';
export const RESPONSE_USER_FAILURE = 'RESPONSE_USER_FAILURE';

// ---- POSITION ---- //
export const GET_COMPANY_POSITIONS = 'GET_COMPANY_POSITIONS';
export const GET_COMPANY_POSITIONS_BY_PAGE = 'GET_COMPANY_POSITIONS_BY_PAGE';
export const CREATE_POSITIONS = 'CREATE_POSITIONS';
export const STORE_POSITIONS_BEFORE_CREATING = 'STORE_POSITIONS_BEFORE_CREATING';
export const DELETE_POSITION = 'DELETE_POSITION';
export const RESET_SHOW_ADD_POSITION_BUTTON = 'RESET_SHOW_ADD_POSITION_BUTTON';
export const RESET_STORE_POSITIONS_BEFORE_CREATING = 'RESET_STORE_POSITIONS_BEFORE_CREATING';

export const RESPONSE_POSITION_SUCCESS = 'RESPONSE_POSITION_SUCCESS';
export const RESPONSE_POSITION_GET_SUCCESS = 'RESPONSE_POSITION_GET_SUCCESS';
export const RESPONSE_POSITION_NOT_FOUND = 'RESPONSE_POSITION_NOT_FOUND';
export const RESPONSE_POSITION_NOT_ACCEPTABLE = 'RESPONSE_POSITION_NOT_ACCEPTABLE';
export const RESPONSE_POSITION_FAILURE = 'RESPONSE_POSITION_FAILURE';