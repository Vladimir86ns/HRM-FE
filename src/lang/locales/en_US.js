module.exports = {
	...
	"sidebar.department.seeAll" : "See All",
	"sidebar.department.addNew": "Add New",
	"sidebar.position": "Position",
	"sidebar.position.seeAll" : "See All",
	"sidebar.position.addNew": "Add New",
	"sidebar.award": "Award",
	...
	"form.formErrorMessage.required": "required",
	"form.formArrayErrorMessage.required": "required",

	"form.accountInfo.heading": "Account Info",
	"form.accountInfo.name": "Name",
	"form.accountInfo.email": "Email",
	"form.companyInfo.heading": "Company Info",
	"form.companyInfo.name": "Name",
	"form.companyInfo.email": "Email",
	"form.companyInfo.website": "Website",
	"form.companyInfo.mobilePhone": "Mobile Phone",
	"form.companyInfo.telephoneNumber": "Telephone Number",
	"form.companyInfo.faxNumber": "Fax Number",
	"form.companyInfo.location.heading": "Location Info",
	"form.companyInfo.location.country": "Country",
	"form.companyInfo.location.region": "Region",
	"form.companyInfo.location.city": "City",
	"form.companyInfo.location.zipCode": "Zip Code",
	"form.companyInfo.location.firstAddressLine": "First Address Line",
	"form.companyInfo.location.secondAddressLine": "Second Address Line",
	...
	"form.position.addNew.description": "Adding names for the position it is possible to add more than one, " + 
		"for given apartment. Names need to be separated with comma, choose which department want. In the name, " +
		"field writes: one, two, tree, four, five ...",
